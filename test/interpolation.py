...
from POT import POT
  # Assuming the VSOT class is in VSOT.py
...
for i in range(len(pressure_files)):
    ...
    df_pressure = df_pressure[400:4000]#.astype(np.float16)
...
doa_data[0] = doa_data[0][0:1000]
doa_data[1] = doa_data[1][0:1000]
p_w_pos[0] = p_w_pos[0][0:1000]
p_w_pos[1] = p_w_pos[1][0:1000]
p_w_neg[0] = p_w_neg[0][0:1000]
p_w_neg[1] = p_w_neg[1][0:1000]
